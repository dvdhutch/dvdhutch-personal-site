  ...
  return (
    <Layout home>
      ...
      <section className={utilStyles.headingMd}>
        ...
        <p> I am an incoming graduate student at <a href="https://www.tc.columbia.edu">Teachers College, Columbia University</a> studying instructional technology and am currently working at <a href="https://www.las.ch">Leysin American School</a> in Switzerland.</p>
        <p> Previously, I worked as a Product Manager at <a href="https://www.liveohana.ai">Ohana</a>, where I led early growth in New York City. I also taught at <a href="https://www.goprojectnyc.org">GO Project</a>, an NYC based non-profit serving students from public schools across the city. </p>
